# CV Element Templates

Use these templates for every vacancy-tailored CV. They are mandatory public-copy constraints; detailed fit analysis and evidence traceability remain private.
...
Include only supported role level, domain, scope, outcomes, ownership, and relevant capability signals. Omit tool chains, implementation inventories, unsupported seniority, vacancy-copy, and material gaps. Never expose a gap as a sentence, apology, disclaimer, or detailed explanation; keep it in private fit analysis and use it to omit a claim or narrow a supported claim.

**Good pattern:** “Builds reliable customer-facing systems and improves delivery quality across complex environments. Solves operational problems through disciplined engineering and relevant platform practices, producing measurable or verified improvements for the business.”

**Bad pattern:** “Developer with no experience in the requested area and only basic exposure to a related tool, without professional deliveries or ownership of complete applications.”

## Professional Experience

**Purpose:** Preserve an Oxford-style accomplishment narrative rather than regress to tool lists.

Each bullet contains one main idea and follows:

`executable action + context/problem + solution/technology evidence + verified outcome or purpose`
...
`Category: relevant supported item, relevant supported item, relevant supported item`
